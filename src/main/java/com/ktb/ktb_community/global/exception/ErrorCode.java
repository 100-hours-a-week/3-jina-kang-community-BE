...
public enum ErrorCode {
    ...
    // auth
    LOGIN_FAILED(HttpStatus.UNAUTHORIZED, "이메일 또는 비밀번호를 잘못 입력했습니다"),
    ...
    PASSWORD_NOT_MATCH(HttpStatus.CONFLICT, "비민번호가 틀렸습니다"),
    PASSWORD_NOT_EQUAL(HttpStatus.CONFLICT, "비밀번호가 일치하지 않습니다"),
